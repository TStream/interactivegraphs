 ...
 * @author user
 */
public class RotatingArcs extends PApplet  {
...
public void setup(){
  ...
  for (int i=0; i<num; i++) {
    ...
    // get colors
    prob = random(100);
    if(prob<30) style[i*2]=colorBlended(random(1), 255,45,100, 35,47,230, 210);
    else if(prob<70) style[i*2]=colorBlended(random(1), 150,53,200, 170,225,255, 110);
    else if(prob<90) style[i*2]=colorBlended(random(1), 200,155,30, 150,155,90, 110);
    else style[i*2]=color(255,0,255, 220);

    if(prob<50) style[i*2]=colorBlended(random(1), 200,655,160, 50,120,250, 210);
    else if(prob<90) style[i*2]=colorBlended(random(1), 255,100,70, 25,155,150, 250);
    else style[i*2]=color(255,255,0, 220);
